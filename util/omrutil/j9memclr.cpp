...
zosGetMaxHeapSizeForCR()
{
	...
	case ZOS64_VMEM_2_TO_32G:
		...
		printf("j9memclr:zosGetMaxHeapSizeForCR() 1 maxHeapForCR = %llu \n", maxHeapForCR);
		break;
	case ZOS64_VMEM_2_TO_64G:
		maxHeapForCR = MAXIMUM_HEAP_SIZE_RECOMMENDED_FOR_COMPRESSEDREFS;
		printf("j9memclr:zosGetMaxHeapSizeForCR() 2 maxHeapForCR = %llu \n", maxHeapForCR);
		break;
	case ZOS64_VMEM_ABOVE_BAR_GENERAL: /* FALLTHROUGH */
		printf("j9memclr:zosGetMaxHeapSizeForCR() 3 maxHeapForCR = %llu \n", maxHeapForCR);
	default:
		printf("j9memclr:zosGetMaxHeapSizeForCR() 4 maxHeapForCR = %llu \n", maxHeapForCR);
		break;
	}
	printf("j9memclr:zosGetMaxHeapSizeForCR() 5 maxHeapForCR = %llu \n", maxHeapForCR);
