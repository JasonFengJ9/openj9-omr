...
public:
	...
	uintptr_t tlhActiveMaximumSize; /**< Current maximum size for TLH allocation, could be changed as per allocationSamplingInterval, same as tlhRealMaximumSize by default. */
